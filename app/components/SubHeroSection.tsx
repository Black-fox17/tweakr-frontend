    ...
    return (
        <motion.div
            ...
            <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }} className="text-xl sm:text-2xl md:text-3xl font-semibold leading-tight mt-8 text-brand">
                "Tweakr: Effortless Citations, Seamless Research"</motion.h1>
            <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
