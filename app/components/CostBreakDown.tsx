    ...
    return (
        <div className="flex items-center justify-start w-full h-full flex-col gap-4 px-4">
            ...
            <div className='flex flex-col items-start w-full gap-2 '>
                ...
                <div className='py-4 flex gap-4 items-stretch justify-center'>
                    <article className='text-[#9E9E9E] p-4 flex flex-col gap-2 text-[18px] border border-[#F3F3F3] max-w-[210px] rounded-sm'>
                    ...
                    <article className='text-[#9E9E9E] bg-[#F7F7F7] p-4 flex flex-col gap-2 text-[18px] border border-[#F3F3F3] max-w-[210px] rounded-sm'>
