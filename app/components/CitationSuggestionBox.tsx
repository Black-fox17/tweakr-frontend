            ...
            {suggestions ? (
                <div className="w-full flex flex-col gap-4 p-4 sm:p-0">
                    ...
                    <div className='flex items-center justify-between w-full px-4 py-2 bg-[#EDEDED] gap-1'>
                        <button
                            onClick={onAcceptAll}
                            className='text-[14px] text-[#010F34] bg-white font-medium border-[#545454] border-[1.75px] rounded-sm shadow-md px-4 py-2 whitespace-nowrap'
                        >
                            Accept All
                        </button>
                        ...
                        <button
                            onClick={onFinalize}
                            className='text-[14px] text-[#010F34] bg-[#31DAC0] font-medium rounded-sm shadow-md px-4 py-2'>
                            Finalize
                        </button>
                    </div>
                </div>
